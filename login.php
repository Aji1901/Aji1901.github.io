...
<h3 style="text-align: center;" class="blue-text">Silahkan Masuk</h3>
<center><p>PENGADUAN DAN PELAYANAN DESA TUK</a></p></center>
<br><center><p>Repost by <a href='' title='' target='_blank'>Aji santoso</a></p></center>
...
<?php 
	if(isset($_POST['login'])){
		...
		elseif($cek2>0){
			...
			echo "<script>alert('Login gagal silahkan periksa kembali')</script>";
		}
